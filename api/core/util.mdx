...
<ResponseField name="return" type="JsonSchema">
...
<ParamField path="jsonSchema" type="JsonSchema" required>
  JSON Schema to generate UI Schema from
</ParamField>

<ParamField path="layoutType" type="string">
...
<ResponseField name="return" type="ControlElement">
